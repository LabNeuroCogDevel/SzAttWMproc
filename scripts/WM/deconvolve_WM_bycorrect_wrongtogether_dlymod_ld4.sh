...
3dDeconvolve \
    ...
    -num_stimts  7 \
        ...
        -stim_times_AM1 2 $oneddir/cue_ld4_Correct.1D "$dmodel" -stim_label 2 cue_ld3 \
        -stim_times_AM1 3 $oneddir/delay_ld1_Correct.1D "$dmodel" -stim_label 3 delay_ld1 \
        -stim_times_AM1 4 $oneddir/delay_ld4_Correct.1D "$dmodel" -stim_label 4 delay_ld3 \
        -stim_times 5 $oneddir/probe_ld1_Correct.1D "$pmodel" -stim_label 5 probe_ld1 \
        -stim_times 6 $oneddir/probe_ld4_Correct.1D "$pmodel" -stim_label 6 probe_ld3 \
