...
write.table(data_table4,file="/Users/mariaj/Desktop/20160316_IDs_dx_4_gretchen.txt")
...
IQ<-read.delim(file="/Users/mariaj/Dropbox/20160303_behavior_data_demos.txt")%>% select(subjid,IQ)
