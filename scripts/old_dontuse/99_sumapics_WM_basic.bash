...
dsetdir=$scriptdir/../group_analyses/WM/ttest_basic_WM_2015-11-12/
# where to save images
imgdir=$scriptdir/../group_analyses/WM/ttest_basic_WM_2015-11-12/imgs
...
for task in cue delay probe; do
