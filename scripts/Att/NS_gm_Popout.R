...
#Popout Analysis
Popout<-read.delim(file="/Volumes/Phillips/P5/group_analyses/Att/mvm/NS_gm_Popout_mean.txt",header=T)
#Popout<-read.delim(file="C:/Users/Dhruv/Documents/GitHub/SzAttWMproc/group_analyses/Att/mvm/NS_gm_Popout_mean.txt",header=T)
...
colnames(Popout.4)<-c("ID","GxC1","GxC2","GxC3","GxCxA1","GxCxA2","GxCxA3")
