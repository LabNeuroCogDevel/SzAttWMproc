...
#Habitual Analysis
Habitual<-read.delim(file="/Volumes/Phillips/P5/group_analyses/Att/mvm/NS_gm_Habitual_mean.txt",header=T)
#Habitual<-read.delim(file="C:/Users/Dhruv/Documents/GitHub/SzAttWMproc/group_analyses/Att/mvm/NS_gm_Habitual_mean.txt",header=T)
...
colnames(Habitual.4)<-c("ID","GxC1","GxC2","GxC3","GxCxA1","GxCxA2","GxCxA3")
