...
#for NUMS in $(cat $NUMBERS); do
 ...
 #   echo "*******************************************************************************************************PROCESSING ${ROI}"
    ...
    setA=/Volumes/Phillips/P5/DUP/seed_fc/subjs/Controls/1*_2*/1*_R1_corrmap_z.nii.gz

    setB=/Volumes/Phillips/P5/DUP/seed_fc/subjs/Controls/1*_2*/1*_R2_corrmap_z.nii.gz
  
    #output file name
    name=/Volumes/Phillips/P5/DUP/seed_fc/groupROIanalyses/R1_R2_compare_controls.nii
