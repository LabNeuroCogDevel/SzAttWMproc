...
# NOTE: edited 6/28/2018 to create Controls only activation maps 
...
# for ROI in $(cat $MASKLIST); do
    ...
    setA=/Volumes/Phillips/P5/DUP/seed_fc/subjs/Controls/1*_2*/1*_${ROI}_parc_corrmap_z.nii.gz

    #output file name
    name=/Volumes/Phillips/P5/DUP/seed_fc/groupROIanalyses/${ROI}_parc_grouplevel_controls.nii
